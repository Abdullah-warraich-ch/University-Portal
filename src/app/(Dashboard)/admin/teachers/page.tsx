...
function Teachers() {
  ...
  async function deleteRecord(uid: string) {
    if (!window.confirm("Are you sure you want to delete this teacher? This will remove their account and all records.")) return;
    try {
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-text-muted text-sm font-medium opacity-80 pl-1">
            Total teachers: <span className="text-primary font-bold">{teachers.length}</span>
          </p>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-background-secondary/50 border-b border-border/20">
                ...
                <th className="py-5 px-6 font-black text-[10px] uppercase tracking-widest text-text-primary/40">Teacher ID</th>
                <th className="py-5 px-6 font-black text-[10px] uppercase tracking-widest text-text-primary/40">Position</th>
                  ...
                  <td className="py-6 px-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] font-black text-text-muted uppercase tracking-tighter mt-0.5">Active</span>
                      </div>
                    </div>
                  </td>
                  <td className="py-6 px-6">
